...
Les [designkontrakten](../../../SDL/docs/integration/SDL-Navigable-Viewpoints-Design.md) for katalogforslag,
...
[Nivå- og notasjonsdesignet](../../../SDL/docs/integration/SDL-Viewpoint-Levels-and-Notation.md) beskriver
...
Verifikasjon registreres i [maskinrapporten](../../../SDL/tools/verification.json).
