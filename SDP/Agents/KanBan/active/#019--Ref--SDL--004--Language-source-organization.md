# KB-SDP-019 — Shared process adoption for SDL and SDUI
...
Primary: [KB-SDL-004](../../../../SDL/SDP/Agents/KanBan/active/%23004--Change--Language-source-organization.md). Apply the phase profile consistently and retain one cross-project plan/evidence trail. SDPTool remains separately tracked by KB-SDP-017; this migration does not implement its discovery contract.
