...
| --- | --- | --- |
| [KB-SDP-017](../active/%23017--Proposal--sdptool-and-project-navigation.md) | T2-M1/M2: Project resolver and configured viewer bridge | P0-M2, T4-M2 and T5 remain in the source; sibling cards own the other selected milestones |
...
2026-09-25T13:17:09Z — EVT-KB-SDP-000144: T2-M1: implement explicit read-only project recognition and manifest facts; T1 is delivered.

2026-09-25T13:20:17Z — EVT-KB-SDP-000145: T2-M1/M2 delivered: read-only project resolver and configured plan/viewer bridge; producer harness checks arguments, source preservation and resource cleanup.
