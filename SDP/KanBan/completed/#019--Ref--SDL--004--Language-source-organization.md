...
Primary: [KB-SDL-004](../superseded/%23004--SDL--Change--Language-source-organization.md). Apply the phase profile consistently and retain one cross-project plan/evidence trail. SDPTool remains separately tracked by KB-SDP-017; this migration does not implement its discovery contract.
