...
Keep the timeline/interactive history idea separate from native status navigation; target the common management ledger.

EVT-KB-SDP-000116; next review at the next selection or relevant dependency delivery.
