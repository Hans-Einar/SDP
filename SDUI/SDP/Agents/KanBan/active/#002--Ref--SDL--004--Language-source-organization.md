...
Primary: [KB-SDL-004](../../../../../SDL/SDP/Agents/KanBan/active/%23004--Change--Language-source-organization.md). Adopt the five phase homes and split SDUI/design/architecture.design. Keep SDUI-specific internals under this project and shared integration in one canonical SDL-owned source set. Retain dated exports as historical evidence.
...
[system-boundary study](../../../../../SDP/03--Architecture/System-Boundaries-study.md). System boundaries in that study are
