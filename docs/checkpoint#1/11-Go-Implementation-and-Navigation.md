...
| SDL-frontend | Design-core 0.5 med struktur/bruksmål, data, channels/scenarioer og planfakta; 151 fryste parserprøver. [G4](../../SystemDesignLanguage/go/evidence/G4.md) |
| SDL-kjøring | Action-core 0.1: typed records/actions og registrerte Go-funksjoner; SDL↔SDUI-bridge, modelreload, Go-rebuild/restart. [Profil](../SDL-Executable-Action-Profile.md) |
| Go-generering | Typede modellkonstruktører, separate håndskrevne domenefunksjoner, identiske kilde-/kompilerte hendelsesspor og state-dokumentasjon. [G5](../../SystemDesignLanguage/go/evidence/G5.md) |
| Dokumenter | 11 viewpoints, statiske kataloger eller lett navigator, typed utvalg, semantiske SVG-symboler, cache/IPC/leases og ekte XFMD-paneler. [G6](../../SystemDesignLanguage/go/evidence/G6.md) |
| Klasser | Class-core 0.1: eksplisitte medlemmer, roller, multiplisitet, aggregation/composition og kildekoblede diagrammer. [Profil](../SDL-Class-Profile.md) |
...
[SDL-kommandoer](../../SystemDesignLanguage/go/README.md) dekker check/AST,
...
uendret fra målbranchens 9ad4324. [Bevis](../../SystemDesignLanguage/go/evidence/sdp-validator-baseline.txt).
