...
| --- | --- | --- |
| Unit, Container, Functionality, Capability, Interface, Activity, Mode | Strukturelt grunnlag | Python design-core 0.2 parser/AST/validator/formatter |
...
| Dataset, Datagram, Database og feltkontrakter | Studie og checkpoint 03 | Ikke implementert i parseren |
...
| VP09 | Hvor kommer data fra og hvor hentes de? Datakart/ER | Dataset, Datagram-kilde/projeksjon, kontrakt, valgfri Database-lagring, eier | Mangelrapport |
| VP10 | Hvordan er én Datagram-variant kodet? Packet | Eksplisitt kodingsprofil med feltrekkefølge, bredde/offset og variant | Mangelrapport |
...
viewpoints og mangelstatus for resten. 211 deklarasjoner og 471 fakta kommer
...
VP07 viser 14 uspesifiserte allokeringer i modusutsnittene. Et delt ansvar kan
...
Disse utsnittene er ikke en komplett deploymentplan for alle 91 ansvar.

Verifikasjon: 67 SVG-diagrammer rendret, 13 verktøytester, 40 SDL-parsertester og
...
| V2 — data og kontrakter | Definer Dataset/Datagram/Database og kontraktinnhold, opprinnelse/projeksjon og ved-behov-persistens; VP09, og VP10 kun for valgt encoding |
...
leveranse er V2. Avklar grammatikk og semantikk på én SDUI-witness, oppdater definisjon/tester samlet, og port til Go i ett løp.
