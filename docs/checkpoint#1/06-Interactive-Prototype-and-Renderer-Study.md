...
viewport obligations. The existing [MVP1 design reconciliation](../MVP1-Design-Evolution-and-SDP-Skills.md)
...
this study. It extends the existing [executable IR direction](../SDL-Executable-IR-and-Runtime-Study.md)
and preserves the [selected MVP1 UI responsibilities](../MVP1-Design-Language-Example.md).
