...
Current discussion entry: [Checkpoint #1](../../../SDP/History/checkpoint-1/README.md), 2026-09-18.
...
`~/git/SDP-research-issue-10-system-design-/SystemDesignLanguage/Mandate-and-Study.md`.
That historical worktree address is no longer an active document link. The
[current SDL mandate](../../Mandate-and-Study.md) is a later maintained document;
the fingerprint below still describes the original inspected file.
...
The [Feature governance proposal](../../../docs/process/Feature-Governance-And-SDP-2.0.md) remains
