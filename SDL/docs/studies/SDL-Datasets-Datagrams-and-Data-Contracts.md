...
the contract. See [checkpoint update 08](../../../SDP/History/checkpoint-1/08-SDL-Viewpoints-and-Implementation-Status.md).
V2 now implements a bounded data/contract/wire profile described in
[the current profile](../profiles/SDL-Data-Contract-Profile.md). The older inline declaration
clauses and wider candidates below are not automatically accepted syntax.

Current consolidation: [Checkpoint #1](../../../SDP/History/checkpoint-1/README.md), 2026-09-18.
