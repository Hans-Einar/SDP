...
G4/G5 replaced the Python design-core 0.5 experiment with the [Go parser](../../SDL/go/README.md). The [language definition](../../SDL/docs/studies/Design-Language-Definition.md) and [example](examples/ui-ownership.design) remain. 151 frozen parser cases live in SDL/go/parser/testdata; 170 diagram projections with original source live in SDL/go/viewpoint/testdata.
