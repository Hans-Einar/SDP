...
SOURCE = '''language design-core version 0.2.
actor Author.
usecase Review.
usecase Prototype.
feature Checking.
...
class GoalTests(unittest.TestCase):
    ...
    def test_missing_allocation_names_and_mode(self):
        errors = dc.validate(dc.parse('language design-core version 0.2.\nMissing allocated-to Unknown in mode Absent.\n'))
    ...
    def test_incomplete_goal_model_is_structurally_valid(self):
        self.assertEqual(dc.check('language design-core version 0.2.\nactor Author.\nfeature Missing.\nusecase Review.\n')[1], [])
